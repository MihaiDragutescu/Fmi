...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private bool ClickOutsideChartArea(double x, double y)
        {
            ...
            minX = grafic.ChartAreas[0].Position.X + 25;
            minY = grafic.ChartAreas[0].Position.Y;

            maxX = minX + grafic.ChartAreas[0].Position.Width * grafic.Width / 100;
            maxY = minY + grafic.ChartAreas[0].Position.Height * grafic.Height / 100;
        ...
        private void grafic_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (ClickOutsideChartArea(e.X, e.Y) == false)
            {
                //MessageBox.Show(x + "  ,   " + y);
        ...
        private void generateBtn_Click(object sender, EventArgs e)
        {
            ...
            Timer[] timers = new Timer[acoperireConvexa.GetNumberOfPoints()];
        ...
        private void DrawLine(object sender, EventArgs e, double x, double y)
        {
